...
public class GetCurrentAuctionUseCaseTest
{
    ...
    public void Seccess()
    {
        //ARRANGE - Tudo que a gente precisa para inicializar para testar o UseCase, fazemos a instanciação
        ...
        //ACT - Ação - No ACT queremos executar as nossas instâncias para passar para o ASSERT
        var auction = useCase.Execute();


        //ASSERT - Queremos testar os resultados
